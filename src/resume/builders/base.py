...
class TemplateError(BuilderError):
    ...
    def __init__(self, message: str, template_path: Optional[Path] = None, format_type: Optional[str] = None) -> None:
...
class RenderError(BuilderError):
    ...
    def __init__(self, message: str, output_path: Optional[Path] = None, format_type: Optional[str] = None) -> None:
