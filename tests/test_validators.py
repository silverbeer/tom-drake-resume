...
class TestBusinessRulesValidation:
    ...
    def test_multiple_current_positions_warning(self, sample_resume_data, temp_schema_file):
        ...
        warning_found = any("current position" in warning.lower() for warning in result.warnings)
    ...
    def test_skills_count_warnings(self, sample_resume_data, temp_schema_file):
        ...
        warning_found = any("skills" in warning.lower() and "10" in warning for warning in result.warnings)
        assert warning_found
